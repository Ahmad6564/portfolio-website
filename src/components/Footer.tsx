            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                ...
                                <li className="mb-2">
                                    <a href="https://www.linkedin.com/in/muhammad-ahmad-846830201/" className="hover:underline hover:text-gray-800 dark:hover:text-gray-200 transition-colors">LinkedIn</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.linkedin.com/in/muhammad-ahmad-846830201/" className="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 transition-colors">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
